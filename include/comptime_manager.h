...
typedef int ComptimeTaskId; // these will be generated by increment of ComptimeManager tasks.size()
...
struct ComptimeTask {
    ...
    vector<ComptimeTaskId> prerequisite_tasks;
    ...
    ComptimeTask() {};
    ComptimeTask(ComptimeTaskId task_id, int scope_id, NodeIndex ast_root, TaskResultType result_type):
